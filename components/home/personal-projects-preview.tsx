...
export function PersonalProjectsPreview() {
	const previewProjects = projects.slice(14, 19);
		...
		<section className="py-16 md:py-12">
			<div className="container px-4">
				<SectionHeader
					...
					description="Check out some of the projects I have worked on to have fun with engineering and learn new skills."
				/>
